...
for team in all_teams:
    ...
    if team in all_teams_in_leagues: 
        ...
        if first_appearance['tournament'] == "PL": 
            all_teams_dict[team] = {"name": name, "elo": 2600, "provisional": True, "max_elo": 2600, "max_elo_date": first_appearance['date'], "games_played": 0, "opp_rts": [], "pts_in_ssn": 0}
        elif first_appearance['tournament'] == "CS":
            all_teams_dict[team] = {"name": name, "elo": 2500, "provisional": True, "max_elo": 2500, "max_elo_date": first_appearance['date'], "games_played": 0, "opp_rts": [], "pts_in_ssn": 0}
        elif first_appearance['tournament'] == "L1": 
            all_teams_dict[team] = {"name": name, "elo": 2350, "provisional": True, "max_elo": 2350, "max_elo_date": first_appearance['date'], "games_played": 0, "opp_rts": [], "pts_in_ssn": 0}
        elif first_appearance['tournament'] == "L2": 
            all_teams_dict[team] = {"name": name, "elo": 2200, "provisional": True, "max_elo": 2200, "max_elo_date": first_appearance['date'], "games_played": 0, "opp_rts": [], "pts_in_ssn": 0}
        ...
        all_teams_dict[team] = {"name": name, "elo": 2000, "provisional": True, "max_elo": 2000, "max_elo_date": first_appearance['date'], "games_played": 0, "opp_rts": [], "pts_in_ssn": 0}
